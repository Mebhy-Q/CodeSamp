					...
					<?php if (woffice_is_user_allowed()) { ?>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class($post_classes); ?>>
							...
							<div id="wiki-page-content" class="intern-padding">
								...
								//only pull sections in this Wiki
								$wiki_display = new Woffice_Wiki_Display_Manager([50,43,44,45,46,47,48,49]);
							...
							<?php 
							if (function_exists( 'woffice_wiki_extension_on' )){
								// CHECK IF USER CAN CREATE WIKI PAGE, if so give them edit privlages
								if ($woffice_role_allowed):  ?>
